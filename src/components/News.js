        ...
        <div className="col s6">
            <div className="card hoverable"><a href={props.url} target="__blank" rel="noopener">
                <div className="card-image waves-effect waves-block waves-light">
                    <img src="https://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2010/03/01/poweredbyguardianBLACK.png" alt="thumbnail" height="320px"></img>
    ...
    return (
        <div className="col s12 m12 l6 xl6">
            <div className="card hoverable"><a href={props.url} target="__blank" rel="noopener">
                <div className="card-image waves-effect waves-block waves-light">
                    {
                        props.image == null ? <img src={`https://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2010/03/01/poweredbyguardianREV.png`} alt="thumbnail"/> : <img src={`${props.image}`} alt="thumbnail"/>
                    }
